<?php
class Evisu_AlertOOS_Block_Product_Configurable extends Mage_Catalog_Block_Product_View_Type_Configurable
{
    /**
    ...
    public function getAllowProducts()
    {
        if (!$this->hasAllowProducts()) {
            ...
            foreach ($allProducts as $product) {
                $product->setOutOfStock(!$product->isSaleable());
                $products[] = $product;
            }
    ...
    public function getJsonConfig()
    {
        ...
        foreach ($this->getAllowProducts() as $product) {
            ...
            foreach ($this->getAllowAttributes() as $attribute) {
                ...
                //Mage::log(array_keys($product->getData()),true,'logconf.log');
            }
        }
