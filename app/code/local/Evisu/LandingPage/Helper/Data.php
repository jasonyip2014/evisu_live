 ...
 */ 
class Evisu_LandingPage_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getScrollrData($data)
    {
        $AnimationDataHtml = '';
        if($data)
        {
            ...
            {
                $AnimationDataHtml .= 'data-' . $animationRule['scroll'] . '="' . $animationRule['animation'] . '" ';
            }
        }
